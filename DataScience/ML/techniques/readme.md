## The Roadmap - Machine Learning Techniques
...
| **Week 8** | Supervised Learning | Generative Models (Naive Bayes Classification) | ⚪ Planned |
| **Week 9** | Discriminative Models | Perceptron & Logistic Regression | ⚪ Planned |
| **Week 10** | Support Vector Machines | Max-margin classification & Kernel trick | ⚪ Planned |
| **Week 11** | Ensemble Methods | Bagging & Boosting (AdaBoost) | ⚪ Planned |
| **Week 12** | Neural Networks | Artificial Neural Networks & Multiclass classification | ⚪ Planned |